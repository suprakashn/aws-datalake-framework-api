...
class Response:
    ...
    def _create_response(self):
        if self.method == "HEALTH" and self.response_status:
        ...
        if self.method == "CREATE" and self.response_status:
        ...
        if self.method == "READ" and self.response_status:
        ...
        if self.method == "UPDATE" and self.response_status:
        ...
        if self.method == "DELETE" and self.response_status:
